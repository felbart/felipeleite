        ...
        <a href="./"><img src={logo} alt="Felipe Leite" width={160}/></a>
          ...
          <ul className='list-none flex justify-end gap-6 py-3'>
           {NAVIGATION_LINKS.map((item, id) =>(
            <li key={id} className='text-md font-semibold font-inter cursor-pointer text-gray-200 uppercase active:text-primary-100 hover:text-primary-100 transition duration-300'><Link to={item.href}>{item.label}</Link></li>
           ))}
 </ul>
        </div>
      </div>
